...
try {
    ...
    // close account
    pl('Closing bank account: ' . $bankAccount1->closeAccount());

    // reopen account
    pl('Reopening bank account: ' . $bankAccount1->reOpenAccount());
    ...
    $bankAccount1->transaction(new WithdrawTransaction(150.0));
